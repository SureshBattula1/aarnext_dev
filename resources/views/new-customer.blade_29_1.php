            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.success) {
                        ...
                        if (userRole == 1) {
                            $('#customerType').val(customer.card_typ_nm).prop('disabled', false);
                            $('#currency').val(customer.currency).prop('disabled', false);
                            $('#grp_name').val(customer.grp_name).change().prop('disabled', false);
                            $('#phone1').val(customer.phone1).prop('disabled', false);
                            $('#email').val(customer.email).prop('disabled', false);
                            $('#cellular').val(customer.cellular).prop('disabled', false);
                            $('#credit_line').val(customer.credit_line).prop('disabled', false);
                            $('#list_num').val(customer.list_num).prop('disabled', false);
                            $('#sub_grp').val(customer.sub_grp).prop('disabled', false);
                            $('#nif_no').val(customer.nif_no).prop('disabled', false);
                            $('#storeLocation').val(customer.store_location).prop('disabled', false);
                            $('#address').val(customer.address).prop('disabled', false);
                            $('#new_city').val(customer.city).prop('disabled', false);
                            $('#states').val(customer.state).change().prop('disabled', false);
                            $('#country').val(customer.country).prop('disabled', false);
                            $('#billing-address-section').show();
                        } else {
                            // For other roles - Disable all fields
                            $('#customerType').val(customer.card_typ_nm).prop('disabled', true);
                            $('#currency').val(customer.currency).prop('disabled', true);
                            $('#grp_name').val(customer.grp_name).change().prop('disabled', true);
                            $('#phone1').val(customer.phone1).prop('disabled', true);

            ...
            <div class="card-body card_bg1">
                ...
                <div class="col-md-2">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="hidden" name="customer_grp_code" id="customer_grp_code" >
                    ...
                    <div class="col-md-3 ">
                        ...
                        <select id="sales_order_id" class="form-control select2-quotation" onchange="fillSalesOrderData(orderId);"  tabindex="3">
                    ...
                    <div class="col-md-3">
                        <div class="form-control input-sm">
                            <input type="text" class="form-control" id="pymnt_grp" name="pymnt_grp" placeholder="credit Days" readonly>
                        </div>
                    </div>

                          <input type="text"  class="form-control" id="due_date" name="due_date" placeholder="Due Date" hidden readonly>
                    ...
                    <div class="customer-details">
                        ...
                        <div class="value_bg1">
                            <input type="date" class="form-control" id="current_date" name="current_date" tabindex="7" readonly/>
                        </div>
                        
                        <div class="customer-pymnt_grp value_bg1"></div>
                        <div class="customer-hike-perc value_bg1"></div>
                        
                        
                        <div class="">
                            <div class="cust_default_discount"></div>
                            <div class="cust_sales_commission value_bg1"></div>
                        </div>
                            ...
                            <table id="branch_table" class="table no-footer small-padding small-heading quotation-form-table">
                                <thead>
                                    <tr class="table-primary">
                                        ...
                                        <div class="col-md-3">
                                        <button id="addRowButton" type="button" class="btn btn-warning addNewRow">Add New Row</button>
                                        </div>
                                        </th>
                                    </tr>
                                </thead>
                                    ...
                                    <tr class="items">
                                        ...
                                        <td class="item_code">
                                            ...
                                            <select class="form-control row_item_no select2-item"
                                                    tabindex="8" name="row_item_no[]" data-live-search="true">
                                                        <!-- <option selected value="">Select Item</option> -->
                                            </select>
                                        </td>
                                        ...
                                        <td>
                                            ...
                                            <!--<input type="text" min="1" onblur="calculate_total(); triggerBatchQuantity();" tabindex="9"
                                                        onchange="calculate_total();" name="row_item_qty[]"
                                                        value="0" class="form-control">-->
                                                <input type="text" min="1" onfocus="removeZero(this)"
                                            onblur="restoreZero(this); calculate_total(); triggerBatchQuantity();"
                                            tabindex="9" onchange="calculate_total();" name="row_item_qty[]"
                                            value="1" class="form-control" oninput="validateInteger(this)">
                                        </td>
                                        ...
                                        <td>
                                            <div class="row_discunt_val">
                                                <input type="text" onblur="calculate_total(1);" onchange="calculate_total(1);" name="row_item_disc[]" id="row_discount" class="form-control" min="0" value="0.00" tabindex="10">
                                            </div>
                                        </td>
                                        <td>
                                            <div class="dis_percentage_val">
                                                <input type="number" name="row_item_disc_percent[]"  min="0" onblur="calculate_total(2);" onchange="calculate_total(2);" id="dis_percentage" value="0.00" class="form-control text-left" tabindex="11">
                                            </div>
                                        </td>
                                        <td>
                                    ...
                                    <!-- Remarks Section -->
                                     ...
                                     <div class="remarks col-4">
                                        <div class="remarks-section">
                                          ...
                                          <div id="remarksError" class="invalid-feedback" style="display:none;">
                                            Remarks cannot exceed 256 characters.
                                          </div>
                                        </div>
                                      </div>
...
<script>
    ...
    remarksInput.addEventListener("input", function () {
      let remaining = MAX_CHARS - this.value.length;
  
      // Update help text with remaining characters
      remarksHelp.textContent = `Remaining characters: ${remaining}`;
  
      if (this.value.length > MAX_CHARS) {
        // Trim text if user pasted extra characters
        this.value = this.value.slice(0, MAX_CHARS);
        remaining = 0;
      }
  
      // Show error if no characters left
      if (remaining === 0) {
...
<script>
    ...
    $(document).ready(function () {
        $("#new_quotation_form").validate({
            ...
            rules: {
                sales_emp_id: { required: true },
                sales_type: { required: true },
            },
            messages: {
                sales_emp_id: { required: "Please select a sales employee." },
                sales_type: { required: "Please select a sales type." },
            },

            submitHandler: function (form) {
                let selectedItemsMap = {}; // Object for tracking selected items
                let hasDuplicates = false; 

                $(".duplicate-warning").remove(); 
                $('select[name="row_item_no[]"]').each(function () {
                    let selectedValue = $(this).val();
                    let $this = $(this); 

                    if (selectedValue) {
                        if (selectedItemsMap[selectedValue]) {
                            hasDuplicates = true;
                            $this.addClass('is-invalid'); 
                            if ($this.next('.duplicate-warning').length === 0) {
                                $this.after('<span class="duplicate-warning text-danger">This item is already selected!</span>');
                            }
                        } else {
                            selectedItemsMap[selectedValue] = true;
                            $this.removeClass('is-invalid');
                            $this.next('.duplicate-warning').remove();
                        }
                    }
                });
                ...
                if (hasDuplicates) {
                    Swal.fire({
                        ...
                        text: 'Please remove duplicate selections before submitting.',
                        showConfirmButton: true,
                    });
                    return false;
                }

                if ($('select[name="row_item_no[]"]').filter(function () { return this.value !== ""; }).length === 0) {
                    Swal.fire({
                        icon: 'warning',
                ...
                $('input[name="row_item_disc_percent[]"]').each(function() {
                    $(this).removeClass('is-invalid');
                    $(this).next('.discount-error').remove();
                });
                ...
                $('input[name="row_item_disc_percent[]"]').each(function() {
                    ...
                    if (val > 99.99) {
                        ...
                        if ($input.next('.discount-error').length === 0) {
                            $input.after('<span class="discount-error text-danger" style="font-size: 0.85em;">Discount cannot exceed 99.99%</span>');
                        }
                    }
                });
                ...
                $.ajax({
                    ...
                    success: function (result) {
                        ...
                        Swal.fire({
                            ...
                            if (result.success) {
                                window.location.href = 'invoice-payment-show/' + result.inv_id;
                            }
                        });
                    },
    ...
    $(document).on('input', 'input[name="row_item_disc_percent[]"]', function () {
        console.log('inside');
        let $this = $(this);
        ...
        if (val <= 99.99) {
            ...
            $this.removeClass('is-invalid');
            $this.nextAll('.discount-error').remove();
        }
    });
    
    $(document).on('change', 'select[name="row_item_no[]"]', function () {
        let selectedValue = $(this).val();
        let $this = $(this);

        if (selectedValue) {
            let isDuplicate = false;
            $('select[name="row_item_no[]"]').not(this).each(function () {
    ...
    $(document).ready(function() {
        ...
        $("#customer_id").on("select2:select", function(e) {
            ...
            $("#customer_grp_code").val(data.grp_code);

            // $('.customer-hike-perc').html("<span class='label blue'>Hike Percentage: </span><span class='value'>" + data
            //     .hike_percent + "</span>").addClass('highlight');
            $('.customer-hike-perc').html(
                "<span class='label blue'>Hike Percentage: </span>" +
                "<span class='value'>" + data.hike_percent + "</span>" +
                "<input type='hidden' name='hike_percent' value='" + data.hike_percent + "'>"
            ).addClass('highlight');

            $('.cust_default_discount').html(
                "<input type='hidden' name='cust_default_discount' value='" + data.default_discount + "' />"
            ).addClass('highlight');

            $('.cust_sales_commission').html(
                "<input type='hidden' name='cust_sales_commission' value='" + data.sales_commission + "' />"
            ).addClass('highlight');

            globalCustomerDiscount = parseFloat(data.default_discount) || 0;
            //$('.customer-pymnt_grp').html(
            //    "<span class='label blue'>Due Date: </span><span class='value'>" +
            //    data.pymnt_grp + "</span>").addClass('highlight');
            ...
            $('.invoice-no').html(
                "<span class='label blue'>Doc Number: </span><span class='value' id='invoice_num'></span>").addClass('highlight');
            $('#current-date').html("<span class='label blue'>Date: </span><span class='value'>" +
                formattedDate + "</span>").addClass('highlight');

        if(data.sub_grp == 'HOSPITAL'){
                $('#sales_type').html(`
                                <option value="hospital">Hospital</option>
                            `)
                            .prop('disabled', false)
                ...
                if( data.grp_name == 'Cash Sales' || data.grp_name == 'Cash Sale' || data.grp_name == 'Cabinda Cash' || data.grp_code == 108){
                    $('#sales_type').html(`
                                    <option value="">Select Sales Type</option>
                                    <option value="cash">Cash</option>
                                    <option value="cash/credit">Cash/Credit</option>
                                ...
                                .addClass('form-control')
                                .trigger('change');
                } else if (data.grp_name == 'Credit Sales' || data.grp_name == 'Credit Sale' || data.grp_name == 'Cabinda Credit' || data.grp_code == 109){
                    $('#sales_type').html(`
                        <option value="">Select Sales Type</option>
                        <option value="credit">Credit</option>
                        <option value="cash">Cash</option>
    ...
    $(document).ready(function() {
            ...
            element.select2({
                ...
                .on('select2:select', function(e) {
                    ...
                    $extraInfoDiv.html(`
                            ...
                            <span style="color: black; font-weight: bold;">Item Code:</span> <span style="color: #ae700c; font-weight: bold;">${selectedData.result.item_code || 'NULL'}</span>,
                            <span style="color: black; font-weight: bold;">Item Name:</span> <span style="color: #ae700c; font-weight: bold;">${selectedData.result.item_name || 'NULL'}</span>,
                            <span style="color: black; font-weight: bold;">WH Quantity:</span> <span style="color: #ae700c; font-weight: bold;">${Math.floor(selectedData.result.quantity) || '0'}</span>
                        </span>
                            `).show();

                       //console.log('Pavan:', selectedData.result.item_code);
                     // var selectedItem = itemSearchResults.find(function(item) {
                     //        return item.item_code === selectedData.result.item_code;
                     //    });

                            currentRow.find('input[name="row_item_id[]"]').val(selectedData.result.id);
                            //currentRow.find('input[name="row_item_no[]"]').val(data.item_code);
                            currentRow.find('input[name="row_item_order_id[]"]').val(selectedData.order_id);
                            currentRow.find('input[name="row_item_price[]"]').val(selectedData.result.price);
                            currentRow.find('input[name="row_item_uom_code[]"]').val(selectedData
                                .uom_code);
                            currentRow.find('input[name="row_item_gst_rate[]"]').val(selectedData.result
                                .tax);
                            let newOption = new Option(selectedData.result.item_code, selectedData.result.item_code, true, true);
                            currentRow.find('.select2-item').append(newOption).trigger('change');

                            customerDefaultDiscount = globalCustomerDiscount;
                            if (customerDefaultDiscount > 0) {
                                currentRow.find('input[name="row_item_disc_percent[]"]').val(customerDefaultDiscount.toFixed(2));
                                let price = parseFloat(currentRow.find('input[name="row_item_price[]"]').val()) || 0;
                                let discountAmount = (price * customerDefaultDiscount) / 100;
                                currentRow.find('input[name="row_item_disc[]"]').val(discountAmount.toFixed(2));
                            }

                            // The following line was changed to use item_code instead of item_id
                            currentRow.find('input[name="row_item_no[]"]').val(selectedData.result.item_code);
                                setTimeout(() => {
                                    currentRow.find('input[name="row_item_qty[]"]').focus();
                                }, 300);


                                // Validate the actual discount value (row_item_disc) and percentage (row_item_disc_percent)
                            currentRow.find('input[name="row_item_disc[]"], input[name="row_item_disc_percent[]"]').on('input', function() {
                                let price = parseFloat(currentRow.find('input[name="row_item_price[]"]').val()) || 0;
                                let maxDiscPercent = 99.99;
                                let maxDiscountValue = (price * maxDiscPercent) / 100;

                                let enteredDiscount = parseFloat(currentRow.find('input[name="row_item_disc[]"]').val()) || 0;
                                let enteredDiscountPercent = parseFloat(currentRow.find('input[name="row_item_disc_percent[]"]').val()) || 0;

                                // Validate discount value
                                if (enteredDiscount > maxDiscountValue) {
                                    alert(`Discount value cannot exceed the maximum allowed discount of ${maxDiscountValue.toFixed(2)}.`);
                                    currentRow.find('input[name="row_item_disc[]"]').val(maxDiscountValue.toFixed(2));
                                }

                                // Validate discount percentage
                                if (enteredDiscountPercent > 99.99) {
                                    alert(`Discount percentage cannot exceed 99.99%.`);
                                    currentRow.find('input[name="row_item_disc_percent[]"]').val(99.99);
                                }
                            });
                    ...
                    // $.ajax({
                    //     url: public_path + "/get-item/" + selectedData.id +'/'+ cardCode,
                    //     dataType: 'json'
        ...
        function addNewRow(isAddNewRow = true) {
            ...
            let baseCount = isAddNewRow ? rowCount * 11 + 1 + 1 : rowCount * 11 + 10;
            let tab1 = baseCount++;
            let tab2 = baseCount++;
            let tab3 = baseCount++;
            let tab4 = baseCount++;
            ...
            <tr class="items items-first-order">
                ...
                <td class="">
                                        ...
                                        <td>
                                            <input type="text" min="1" onblur="restoreZero(this); calculate_total(); triggerBatchQuantity();" tabindex="${tab2}" autocomplete="off"
                                                 onfocus="removeZero(this)" onchange="calculate_total();" name="row_item_qty[]"
                                                        value="1" class="form-control" oninput="validateInteger(this)">
                                        </td>
                                        {{--<td>
                                        ...
                                        <td class="rate" id="rate">
                                            <input type="number" width:100px data-toggle="tooltip" title="" onblur="calculate_total();" onchange="calculate_total();" name="row_item_price[]" value="" readonly class="form-control" autocomplete="off">
                                        </td>
                                        <td>
                                            <div class="row_discunt_val">
                                                <input type="text" onblur="calculate_total(1);" onchange="calculate_total(1);" name="row_item_disc[]" id="row_discount" class="form-control" min="0" value="0.00" tabindex="${tab3}" autocomplete="off">
                                            </div>
                                        </td>
                                        <td>
                                            <div class="dis_percentage_val">
                                                <input type="number" name="row_item_disc_percent[]"  min="0" onblur="calculate_total(2);" onchange="calculate_total(2);" id="dis_percentage" value="0.00" class="form-control text-left" tabindex="${tab4}" autocomplete="off">
                                            </div>
                                        </td>
                                        <td>
                                            <div class="price_af_discount">
...
function custAdreeses() {
    var cardCode = $('#customer_id').val();
    if (cardCode) {
        // If customer is selected, make the AJAX call for the customer addresses
        $.ajax({
            url: public_path + "/customer-address-list/" + cardCode,  // Call API with selected customer ID
            type: 'GET',
            dataType: 'json',
            success: function(response) {
                if (response.customer) {
                    var pymnt_grp = response.customer.pymnt_grp;
                    if (pymnt_grp) {
                        $('#pymnt_grp').val(pymnt_grp);

                        // Calculate due date using API endpoint
                        $.ajax({
                            url: public_path + "/calculate-due-date",  // Call API to calculate due date
                            type: 'POST',
                            data: {
                                pymnt_grp: pymnt_grp,
                        ...
                        $('#pymnt_grp').val('Cash Basic');
                        $('#due_date').val('Today');
                    }

                    // Populate addresses dropdown
                    $("#cust_address_id").empty();  // Clear previous options
                    if (response.addresses && response.addresses.length > 0) {
                        response.addresses.forEach(function(address) {
                            ...
                            $("#cust_address_id").append(new Option(optionText, address.id));
                        });
                        $("#cust_address_id").select2({
                            placeholder: "Select Customer Address",
                            allowClear: true,
                        ...
                        $("#cust_address_id").append(new Option('No addresses found', '', false, false));
                        $("#cust_address_id").prop('disabled', true);  // Disable the dropdown if no addresses
                    }
                } else {
...
<script>
    ...
    function triggerBatchQuantity(itemId , quantity , $row) {
        if(!itemId){
            ...
            var quantity = $row.find('input[name="row_item_qty[]"]').val();
        }
        if (!itemId) {
        ...
        fetch(`get-batches/${itemId}/${quantity}`, {
            method: 'GET',
            headers: {
    ...
    //                remarksData = response.remarks;
    //                //console.log('remarksData' , remarksData)
    //                autoFillSalesOrderFields(order);
    ...
    $.ajax({
        ...
        success: function(response) {
            if (response) {
                ...
                let RefNO = response.sales_ref_no;
                let SalesType = response.sales_type;

                // Auto-fill fields and trigger necessary functions
                autoFillSalesOrderFields(order);
                ...
                let $salesTypeSelect = $('#sales_type');
                    if ($salesTypeSelect.find(`option[value="${SalesType}"]`).length) {
                        $salesTypeSelect.val(SalesType);
                    } else {
                        $salesTypeSelect.append(`<option value="${SalesType}" selected>${SalesType}</option>`);
                    }
        ...
        error: function(xhr, status, error) {
            alert('This sales order is expired .');
            console.error('Error fetching Sales Order data:', error);
        }
    });
}
    ...
    function autoFillSalesOrderFields(orders) {
        if ($('.items-row .items:last .select2-item').val() !== '' && 
            $('.items-row .items:last .select2-item').val() !== 'undefined') {
            $('.items-row .items:last').remove();
        }
        $('.items-row').empty();
        ...
        orders.forEach((order, index) => {
            const randomId = generateRandomId();
                ...
                //if (itemId && quantity) {
                //    alert("works")
                //    triggerBatchQuantity(itemId, quantity);
                //} else {
                //    console.error('itemId or quantity is missing or invalid.');
                //}
            ...
            let newRow = ` 
                                ...
                                <input type="hidden" name="row_item_order_id[]" value="${order.order_id}">
                                 ...
                                 <td class="">
                                        ...
                                        <td>
                                            <div class="dis_percentage_val">
                                                <input type="number" name="row_item_disc_percent[]"  min="0" onblur="calculate_total(2);" onchange="calculate_total(2);" id="dis_percentage" value="${order.disc_percent}" class="form-control text-left" tabindex="${tab3}">
                                            </div>
                                        </td>
                                        <td>
                                            <div class="price_af_discount">
            ...
            let tablerow = $(`tr#${randomId}`);
            const $row = tablerow; 
                if (order.item_no && order.quantity) {
                    triggerBatchQuantity(order.item_no, order.quantity, $row);
                } else {
                    console.error('Item number or quantity is missing for this order.');
                }

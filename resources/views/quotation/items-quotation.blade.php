...
<form id="new_quotation_form" action="javascript:void(0)" method="POST" autocomplete="off">
    ...
    <div class="content-wrapper quo-item-dop">
        <div class="content">
            <h4 class="page_lable_title1">QUOTATION GENERATION</h4>
        </div>
        <div class="card">
                        ...
                        <table width="100%" border="0" cellpadding="0" cellspacing="0">
                            <tr>
                                ...
                                <td width="80%" class="pada0 customerSec">
                                    <select tabindex="1" required class="form-control select2 md-select2" name="customer_id" id="customer_id" onchange="custAdreeses();" data-live-search="true">
                                    </select>
                                ...
                                <tbody class="items-row">
                                    <tr class="items">
                                        ...
                                        <td class="item_code">
                                            ...
                                            <select class="form-control row_item_no select2-item" tabindex="3" name="row_item_no[]" data-live-search="true">
                                                <!-- <option selected value="">Select Item</option> -->
                                            </select>
                                        </td>
                                        ...
                                        <td>
                                            ...
                                            <!--<input type="text" min="1" onblur="calculate_total(); triggerBatchQuantity();" tabindex="5" onchange="calculate_total();" name="row_item_qty[]" value="0" class="form-control">-->
...
<script>
    ...
    $(document).ready(function() {
        ...
        sales_type: {
            ...
            , submitHandler: function(form) {
                ...
                $.ajax({
                    url: public_path + '/store-items-quotation'
                    , method: 'post'
                    ...
                    , success: function(result) {
                        ...
                        if (result.success == 1) {
                            ...
                            window.open(result.QuotationpdfUrl, '_blank');
    ...
    $(document).ready(function() {
        $("#customer_id").select2({
            ajax: {
                url: public_path + "/store-customer-search"
                , dataType: 'json'
                , data: function(params) {
                    var query = {
                        search: params.term
    ...
    //        if (type === 'item_no') {
    //            url = public_path + "/quotation-item-search/item_no";
    //        }
    //        element.select2({
    //                ajax: {
    //                    url: url
            ...
            element.select2({
                ...
                .on('select2:select', function(e) {
                    ...
                    $extraInfoDiv.html(`
                            ...
                            <span style="color: black; font-weight: bold;">Item Code:</span> <span style="color: #ae700c; font-weight: bold;">${selectedData.item_code || 'NULL'}</span>,
                            <span style="color: black; font-weight: bold;">Item Name:</span> <span style="color: #ae700c; font-weight: bold;">${selectedData.item_name || 'NULL'}</span>,
                            <span style="color: black; font-weight: bold;">WH Quantity:</span> <span style="color: #ae700c; font-weight: bold;">${Math.floor(selectedData.quantity) || '0'}</span>
                            `).show();
        ...
        function addNewRow(isAddNewRow = true) {
            ...
            <tr class="items items-first-order">
                ...
                <td class="">
                                        ...
                                        <td>
                                            <input type="text" min="1" onblur="restoreZero(this); calculate_total(); triggerBatchQuantity();" tabindex="${tab2}"
                                                       onfocus="removeZero(this)" onchange="calculate_total();" name="row_item_qty[]" oninput="validateInteger(this)" autocomplete="off"
...
<script>
    ...
    function custAdreeses() {
        ...
        if (cardCode) {
            $("#cust_address_id").select2({
                ajax: {
                    url: public_path + "/customer-address-list/" + cardCode
                    , dataType: 'json'
                    , data: function(params) {
                        return {
                            search: params.term
                ...
                , templateResult: function(data) {
                    ...
                    return $('<span style="font-weight: bold; color: black; font-size: 14px;">' + data.text + '</span>');
                }
    ...
    function displayBatches(batches, $row) {
        ...
        if (batches && batches.length > 0) {
            batches.forEach(function(batch) {
                var batchInfo =
                    `<div>Batch Number: ${batch.batch_quantity}, Expiry Date: ${batch.in_date}</div>`;
                batchList.append(batchInfo);
            });
        } else {
            batchList.html('<div>No available batches found for this item.</div>');
        }
    }

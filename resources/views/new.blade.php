...
<script>
    ...
    //            $('#processingTextFARMACIA 3AAA	Submit').show();
    //            $.ajax({
    ...
    //                        console.log(result.inv_id);
    //                        Swal.fire({
    //                            icon: 'success', 
    //                            title: result.message,
    //                            showConfirmButton: true,
    //                        });
    //                      //  window.open('invoice-payment-show/'+result.inv_id);
    ...
    $(document).ready(function() {
        ...
        //        if (data.grp_code == 102 || data.grp_code == 108) {
        ...
        //            .trigger('change');
        //        }
        //    } else if (data.grp_code == 103 || data.grp_code == 109) {
        //        if (data.sub_grp === 'HOSPITAL') {
        //            $('#sales_type').html(`
        //                <option value="hospital">Hospital</option>
        //                <option value="cash">Cash</option>
        ...
        //            .trigger('change');
        //        }
        //    } else if (data.grp_code == 106) {
        //        $('#sales_type').html(`
        //            <option value="inter_company">Inter COMPANY TRANSFER</option>
        //        `)
        //        .prop('disabled', false)
        //        .val('inter_company')
        //        .addClass('form-control')
        ...
        if(data.sub_grp == 'HOSPITAL'){
                ...
                if( data.grp_name == 'Cash Sales'){
                    $('#sales_type').html(`
                                ...
                                .addClass('form-control')
                                .trigger('change');
                } else if (data.grp_name == 'Credit Sales'){
                    $('#sales_type').html(`
                        <option value="credit">Credit</option>
                        <option value="cash">Cash</option>
                        <option value="cash/credit">Cash/Credit</option>

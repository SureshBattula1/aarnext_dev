                ...
                <div class="card-body card_bg1">
                    <div class="row">
                            ...
                            <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td width="20%" class="pada0">
                                        <div class="sec_bor1 fs14" for="customer_id" style="padding:4px 10px;">Customer:
                                        </div>
                                    </td>
                                    <td width="80%" class="pada0 customerSec">
                                        <select required class="form-control md-select2" name="customer_id" id="customer_id"
                                            onchange="fetchQuotations(this.value); custAdreeses();" data-live-search="true"
                                            tabindex="1">
                                        </select>
                        ...
                        <div class="row details2row">
                                    ...
                                    <tr>
                                        ...
                                        <td width="60%" class="pada0">
                                            <input type="text" class="form-control" id="ref_no" name="ref_no"
                                                tabindex="" placeholder="Enter Ref Number">
                                        </td>
                            ...
                            <div class="col-md-2">
                                <select id="cust_address_id" name="cust_address_id" class="form-controls selesEmpInp"
                                    tabindex="3">
                            ...
                            <div class="col-md-3">
                                <select class="form-control input-sm" name="sales_type" id="sales_type">
                            ...
                            <div class="customer-details">
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <p class="customer-hike-perc value_bg1"></p>
                                    </div>
                                    <div class="col-md-3">
                                ...
                                <div class="row">
                                    ...
                                    <div style="width:120px;">
                                        <button type="button" class="btn btn-primary"
                                            onclick="importExcelData()">Import</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-12">
                            <div class="table-responsive">
                                <table id="branch_table"
                                    class="table no-footer small-padding small-heading quotation-form-table">
                                    <thead>
                                        <tr class="table-primary">
                                            ...
                                            <th width="3%" align="center">
                                                <div class="col-md-3">
                                                    <button id="addRowButton" type="button"
                                                        class="btn btn-warning addNewRow">Add New Row</button>
                                                </div>
                                            </th>
                                        ...
                                        <tr class="items">
                                            ...
                                            <td>
                                                ...
                                                <input type="text" min="1" onfocus="removeZero(this)"
                                                    ...
                                                    tabindex="5" onchange="calculate_total();" name="row_item_qty[]"
                                                    value="1" class="form-control" oninput="validateInteger(this)">
                                            </td>

                                            <td class="rate" id="rate">
                                                <input type="number" width:100px data-toggle="tooltip" title=""
                                                    onblur="calculate_total();" onchange="calculate_total();"
                                                    name="row_item_price[]" value="" readonly class="form-control">
                                            </td>
                                            <td>
                                                <div class="row_discunt_val">
                                                    <input type="text" onblur="calculate_total(1);"
                                                        onchange="calculate_total(1);" name="row_item_disc[]"
                                                        id="row_discount" class="form-control" min="0"
                                                        value="0.00">
                                                </div>
                                            </td>
                                            <td>
                                                <div class="dis_percentage_val">
                                                    <input type="number" name="row_item_disc_percent[]" min="0"
                                                        onblur="calculate_total(2);" onchange="calculate_total(2);"
                                                        id="dis_percentage" value="0.00"
                                                        class="form-control text-left">
                                                </div>
                                            </td>
                                            <td>
                                                <div class="price_af_discount">
                                                    <input type="text" onblur="calculate_total();"
                                                        onchange="calculate_total();" name="row_price_af_disc[]"
                                                        id="price_af_discount" readonly class="form-control"
                                                        value="" style="margin-bottom: 4px;">
                                                </div>
                                            </td>
                                            <!--<td>
                                            ...
                                            <td>
                                                <div class="item_tax_pecent">
                                                    <div style="display:flex;flex-direction:row; ">
                                                        <lable class="sec_bor1"
                                                            style="height: 16px;font-size: 9px; width:24px !important;">%
                                                        </lable>
                                                        <input type="text" name="row_item_gst_rate[]"
                                                            id="item_tax_percent" value="" readonly
                                                            class="form-control tax text-left">
                                                    </div>
                                                    <div style="display:flex;">
                                                        <lable class="sec_bor1" style="height: 16px;font-size: 9px;">Value
                                                        </lable>
                                                        <input type="text" name="row_item_gst_rate_value[]"
                                                            id="tax_value" value="" readonly
                                                            class="form-control tax text-left">
                                                    </div>
                                                </div>
                                            </td>
                                            ...
                                            <td>
                                                <div class="second-row-container">
                                                    ...
                                                    <button type="button" class="bor_none remove-row-btn">
                                                        <img src="{{ asset('images/close-icon.png') }}" alt="Close"
                                                            title="Close" style="width:22px; height:22px;">
                                                    </button>
                                ...
                                <div class="summaryTbl">
                                    <div class="row summaryTable">
                                        ...
                                        <div class="summary-section col-4">
                                            ...
                                            <div class="summary-item">
                                                <div class="summary-label"><strong>Price Total After Discount:</strong>
                                                </div>
...
@push('scripts')
    ...
    <script>
        // expose the user’s role on window
        window.roleAccess = @json(auth()->user()->role);
    </script>
    ...
    <script>
        $(document).ready(function() {
            ...
            $("#new_quotation_form").validate({
                ...
                messages: {
                    sales_emp_id: {
                        required: "Please select a sales employee."
                    },
                    sales_type: {
        ...
        $(document).ready(function() {
            ...
            $("#customer_id").on("select2:select", function(e) {
                ...
                $('.customer-hike-perc').html(
                        "<span class='label blue'>Hike Percentage: </span><span class='value'>" + data
                        .hike_percent + "</span>" +
                        "<input type='hidden' name='hike_percent' value='" + data.hike_percent + "' />")
                    .addClass('highlight');

                $('.cust_default_discount').html(
                    "<input type='hidden' name='cust_default_discount' value='" + data
                    .default_discount + "' />"
                ).addClass('highlight');
                ...
                $('.invoice-no').html(
                    "<span class='label blue'>Quotation Number: </span><span class='value' id='invoice_num'></span>"
                    ).addClass('highlight');
                ...
                if (data.sub_grp == 'HOSPITAL') {
                    ...
                    if (data.grp_name == 'Cash Sales' || data.grp_name == 'Cash Sale' || data.grp_name ==
                        'Cabinda Cash' || data.grp_code == 108) {
                        $('#sales_type').html(`
                                    <option value="">Select Sales Type</option>
                                    <option value="cash">Cash</option>
                                    <option value="cash/credit">Cash/Credit</option>
                            ...
                            .addClass('form-control')
                            .trigger('change');
                    } else if (data.grp_name == 'Credit Sales' || data.grp_name == 'Credit Sale' || data
                        .grp_name == 'Cabinda Credit' || data.grp_code == 109) {
                        $('#sales_type').html(`
                        <option value="">Select Sales Type</option>
                        <option value="credit">Credit</option>
                        <option value="cash">Cash</option>
        ...
        $(document).ready(function() {
                        ...
                        ajax: {
                            ...
                            data: function(params) {
                                ...
                                if (!cardCode) {
                                    ...
                                    'required'); // Keep the required field
                                } else {
                    ...
                    .on('select2:select', function(e) {
                        ...
                        $.ajax({
                            ...
                            success: function(data) {
                                ...
                                currentRow.find('input[name="row_quotation_id[]"]').val(data
                                    .quotation_id);
                                ...
                                if (customerDefaultDiscount > 0) {
                                    currentRow.find('input[name="row_item_disc_percent[]"]').val(
                                        customerDefaultDiscount.toFixed(2));
                                    let price = parseFloat(currentRow.find(
                                        'input[name="row_item_price[]"]').val()) || 0;
                                    let discountAmount = (price * customerDefaultDiscount) / 100;
                                    currentRow.find('input[name="row_item_disc[]"]').val(
                                        discountAmount.toFixed(2));
                                }
                                // Validate the actual discount value (row_item_disc) and percentage (row_item_disc_percent)
                                currentRow.find(
                                    'input[name="row_item_disc[]"], input[name="row_item_disc_percent[]"]'
                                    ).on('input', function() {
                                    let price = parseFloat(currentRow.find(
                                        'input[name="row_item_price[]"]').val()) || 0;
                                    ...
                                    let enteredDiscount = parseFloat(currentRow.find(
                                        'input[name="row_item_disc[]"]').val()) || 0;
                                    let enteredDiscountPercent = parseFloat(currentRow.find(
                                            'input[name="row_item_disc_percent[]"]')
                                        .val()) || 0;

                                    // Validate discount value
                                    if (enteredDiscount > maxDiscountValue) {
                                        alert(
                                            `Discount value cannot exceed the maximum allowed discount of ${maxDiscountValue.toFixed(2)}.`);
                                        currentRow.find('input[name="row_item_disc[]"]')
                                            .val(maxDiscountValue.toFixed(2));
                                    }
                                ...
                                let newOption = new Option(data.item_code, data.item_code, true,
                                    true);
                        ...
                        if ($('.items-row .items:last .select2-item').val() &&
                            $('.items-row .items:last input[name="row_item_qty[]"]').val()) {
                            addNewRow();
                        }
            ...
            <tr class="items items-first-order">
                ...
                <td class="">
                                        ...
                                        <td>
                                            <input type="text" min="1" onfocus="removeZero(this)" onblur="restoreZero(this); calculate_total(); triggerBatchQuantity();" autocomplete="off"
                                                        onchange="calculate_total();" name="row_item_qty[]"
                                                        value="1" class="form-control" tabindex="" oninput="validateInteger(this)">
                                        </td>
                                        {{-- <td>
                                        ...
                                        <td>
                                            <div class="row_discunt_val">
                                                <input type="text" onblur="calculate_total(1);" onchange="calculate_total(1);" name="row_item_disc[]" id="row_discount" class="form-control" min="0" value="0.00" autocomplete="off">
                                            </div>
                                        </td>
                                        <td>
                                            <div class="dis_percentage_val">
                                                <input type="number" name="row_item_disc_percent[]"  min="0" onblur="calculate_total(2);" onchange="calculate_total(2);" id="dis_percentage" value="0.00" class="form-control text-left" autocomplete="off">
                                            </div>
                                        </td>
                                        <td>
                                            <div class="price_af_discount">
        ...
        function calculate_total(caller = 0, $row = null) {
            ...
            // --- Calculate discount based on caller ---
            if (caller === 2) {
                // Called from discount percent field
                discount = (price * discountPercent / 100);
                discount = parseFloat(discount.toFixed(2)); // Round once here
                $row.find('input[name="row_item_disc[]"]').val(discount.toFixed(2));
            }

            if (caller === 1) {
                // Called from discount value field
                discountPercent = (discount / price) * 100;
            ...
            $row.find('input[name="row_item_gst_rate_value[]"]').val((priceAfterDiscount * taxPercent / 100).toFixed(2));

            // --- Final amount with tax ---
            var finalAmount = totalAfterDiscount + taxValue;
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response) {
                        ...
                        let RefNO = response.quotation_ref_no;
                        let SalesType = response.sales_type;

                        autoFillQuotationFields(quotation);
                        $('#remarks').val(remarks);
                        $('#ref_no').val(RefNO);
                        ...
                        if ($salesTypeSelect.find(`option[value="${SalesType}"]`).length) {
                            ...
                            $salesTypeSelect.append(
                                `<option value="${SalesType}" selected>${SalesType}</option>`);
                        }
        ...
        function autoFillQuotationFields(quotations) {
            ...
            quotations.forEach((quotation, index) => {
                ...
                let newRow = `
                                ...
                                <input type="hidden" name="row_quotation_id[]" value="${quotation.quotation_id}">

                                <td class="">
                                            <select class="select2-container form-control" name="row_item_no[]" data-live-search="true">
                                                    <option selected value="${quotation.item_no}">${quotation.item_no}-${quotation.item_desc}-(WHS QTY/ ${ quotation.ws_qty})</option>
                                            </select>
                                        </td>
                                        ...
                                        <td>
                                            <input type="text" min="1" onblur="calculate_total(); triggerBatchQuantity();"
                                                        onchange="calculate_total();" name="row_item_qty[]"
                                                        value="${quotation.quantity}" class="form-control row_item_qty" tabindex="" autocomplete="off">
                                        </td>
                                        ...
                                        <td>
                                            <div class="row_discunt_val">
                                                <input type="text" onblur="calculate_total(1);" onchange="calculate_total(1);" name="row_item_disc[]" id="row_discount" class="form-control" min="0" value="${quotation.disc_value}" tabindex="" autocomplete="off">
                                            </div>
                                        </td>
                                        <td>
                                            <div class="dis_percentage_val">
                                                <input type="number" name="row_item_disc_percent[]"  min="0" onblur="calculate_total(2);" onchange="calculate_total(2);" id="dis_percentage" value="${quotation.disc_percent}" class="form-control text-left" tabindex="" autocomplete="off">
                                            </div>
                                        </td>
                                        <td>
                                            <div class="price_af_discount">
                                    ...
                                    <tr class="extra-info-row items">
                                        <td colspan="6">
                                            <div class="extra-info">
                                             <strong style="color: #4a90e2; font-weight: bold;">Description:</strong> 
                                             <span style="color: black; font-weight: bold;">Item Code:</span> <span style="color: #ae700c; font-weight: bold;">${quotation.item_no || 'NULL'}</span>, 
                                             <span style="color: black; font-weight: bold;">Item Name:</span> <span style="color: #ae700c; font-weight: bold;">${quotation.item_desc || 'NULL'}</span>, 
                                             <span style="color: black; font-weight: bold;">WH Quantity:</span> <span style="color: #ae700c; font-weight: bold;">${quotation.ws_qty || '0'}</span>
                                            </div>
                                        </td>
                                    </tr>`;
    ...
    <script>
        function importExcelData() {
            ...
            reader.onload = function(e) {
                ...
                console.log("workbook Excel Data:", workbook);
                ...
                let cardCode = $('#customer_id').val();
                if (!cardCode) {
                    alert("Please select a customer before importing.");
                    return;
                }
                ...
                autofillImport(sheetData, cardCode);
            };
        ...
        function autofillImport(sheetData, cardCode) {
            $('.items-row').empty();

            // Grab the role once
            const roleAccess = window.roleAccess;

            let ajaxRequests = sheetData.map((row, index) => {
                ...
                if (!itemCode) {
                    console.warn(`Skipping row ${index + 1}: Missing ItemCode`);
                    return null;
                }

                return $.ajax({
                    url: public_path + "/item_search_by_code/" + itemCode,
                    data: {
                        card_code: cardCode
                    },
                    dataType: 'json',
                }).done((data) => {
                    if (!data || !data.price || !data.item_name) {
                        console.warn(`Item ${itemCode} not found in API response.`);
                        return;
                    }
                    ...
                    // build the <tr> differently depending on roleAccess
                    let inputsHtml;
                    if (roleAccess === 5) {
                        inputsHtml = `
                        <td>
                            <input type="text" min="1"
                            onblur="calculate_total(); triggerBatchQuantity();"
                            onchange="calculate_total(); triggerBatchQuantity();"
                            name="row_item_qty[]" value="${quantity}"
                            class="form-control row_item_qty" tabindex="${tab1}">
                        </td>
                        <td>
                            <input type="number"
                            onblur="calculate_total();"
                            onchange="calculate_total();"
                            name="row_item_price[]" value="${price}" readonly
                            class="form-control">
                        </td>
                        <td>
                            <div class="row_discunt_val">
                            <input type="text"
                                onblur="calculate_total(1);"
                                onchange="calculate_total(1);"
                                name="row_item_disc[]" id="row_discount"
                                class="form-control" min="0" value="0.00">
                            </div>
                        </td>
                        <td>
                            <div class="dis_percentage_val">
                            <input type="number"
                                name="row_item_disc_percent[]" min="0"
                                onblur="calculate_total();"
                                onchange="calculate_total();"
                                id="dis_percentage" value="${discount}"
                        ...
                        <td>
                            ...
                            onblur="calculate_total();"
                            onchange="calculate_total();"
                            name="row_item_price[]" value="${data.price}" readonly
                            class="form-control">
                        </td>
                        <td>
                            <div class="row_discunt_val">
                    ...
                    let newRow = `
                        ...
                        <td>
                            <select class="select2-container form-control"
                                    name="row_item_no[]" data-live-search="true">
                            <option selected value="${data.item_code}">
                        ...
                        <td>
                            ...
                            onblur="calculate_total();"
                            onchange="calculate_total();"
                            name="row_price_af_disc[]" readonly
                            class="form-control" value="">
                        </td>

                        <td class="item_tax_pecent">
                            <div style="display:flex;flex-direction:row;">
                            <label class="sec_bor1"
                                    style="height:16px;font-size:9px;width:24px!important;">%</label>
                            <input type="text" name="row_item_gst_rate[]"
                                    id="item_tax_percent"
                                    value="${data.tax || 0}"
                                    readonly class="form-control tax text-left">
                            </div>
                            <div style="display:flex;">
                            <label class="sec_bor1"
                                    style="height:16px;font-size:9px;">Value</label>
                            <input type="text" name="row_item_gst_rate_value[]"
                                    readonly class="form-control tax text-left">
                            </div>
                        </td>
                    ...
                    // trigger batches & totals
                    triggerBatchQuantity(data.item_code, quantity, tablerow);
                    calculate_total(2, tablerow);
                });
            });

            // after all Ajax calls finish
            $.when.apply($, ajaxRequests.filter(r => r)).done(() => {

            ...
            <div class="card-body card_bg1">
                <div class="row">
                    ...
                    <div class="col-md-6">
                            ...
                            <tr>
                                ...
                                <td width="80%" class="pada0 customerSec">
                                   <select required class="form-control md-select2" name="customer_id" id="customer_id"
                                    onchange="fetchQuotations(this.value); custAdreeses();" data-live-search="true" tabindex="1">
                                </select> 
                            ...
                            <table class="" width="100%" border="0" cellpadding="0" cellspacing="0">
                                <tr>
                                    ...
                                    <td width="60%" class="pada0">
                                        <input type="text" class="form-control" id="ref_no" name="ref_no" tabindex="" placeholder="Enter Ref Number">
                                    </td>
                        ...
                        <div class="col-md-2">
                            <select id="cust_address_id" name="cust_address_id" class="form-controls selesEmpInp" tabindex="3">
...
@push('scripts')
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $('.invoice-no').html(
                "<span class='label blue'>Quotation Number: </span><span class='value' id='invoice_num'></span>").addClass('highlight');
                    ...
                    $extraInfoDiv.html(`
                        ...
                        $.ajax({
                            ...
                            success: function (data) {
                                ...
                                currentRow.find('input[name="row_quotation_id[]"]').val(data.quotation_id);

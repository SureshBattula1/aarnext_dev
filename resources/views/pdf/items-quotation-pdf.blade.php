...
<body>
                ...
                <tr>
                    ...
                    <th width="50%">
                        <div class="header-content">
                            <h1 style="font-size: 0ch">{{ $ware_house_data->company_name }}</h1>

                            @php
                                $address = wordwrap($ware_house_data->address, 35, "\n", true);
                            @endphp

                            <p>{!! nl2br(e($address)) !!}, {{ $ware_house_data->location }}</p>
                    ...
                    <th width="20%">
                        <div class="para-content">
                            ...
                            <p style="font-weight: bold; font: height 18px;">{{ $quotation->customer_code }}</p>
                            <div style="margin-top:3px; font-size:14px;">{{$custAddress->address ?? ''}}</div>
                            <p style="font-weight: bold; font: height 18px;">{{ $quotation->nif_no }}</p>

                        </div>
                    </th>
                    <th width="10%" style="text-align: center; vertical-align: top;">
                        <div class="invoice-title">
                            <span class="title-text">Cotação de Vendas</span>
                        </div>
                    </th>
                </tr>
            </table>
   ...
   <div class="footer item-container">
    <div class="col-sm-12 text-align:left">
         Processado por programa validado n.º 96/AGT/2019 | SAP Business One 10.0
    </div>
    <table>
        <tr>
            <td>
            ...
            <td>
                <p class="col-4 highlight-p text-center">
                    <span class="highlight">Cotação Nº.:</span> FT {{ $quotation->quotation_pdf_no }}
                </p>
            </td>
            <td>
    ...
    <div style="margin-top: 3px;" class="customer-name">
        <span><strong>Customer Name:</strong></span> {{ $quotation->customer_name }}
    </div>

    <div style="margin-top: 3px; border: solid 1px #000; border-bottom: none; padding-top: 5px;">
        <table class="invoice-summary">
            <tr>
                <td><span class="highlight">Quotation No.</span>{{ $quotation->quotation_pdf_no }}</td>
                <td><span class="highlight">Data:</span>{{ \Carbon\Carbon::parse($quotation->date)->format('d-m-Y') }}</td>

...
<body>
                ...
                <tr style="font-family: 'Roboto',sans-serif;">
                    ...
                    <th width="50%">
                        <div class="header-content">
                            <h6 style="font-size: 0ch;">{{ $ware_house_data->company_name }}</h6>
                    ...
                    <th width="10%" style="text-align: center; vertical-align: top;">
                        <div class="invoice-title">
                            <span class="title-text" style="font-size: 17px">NOTA DE CRÉDITO</span>
                        </div>
                    </th>
                </tr>
            </table>
   ...
   <div class="footer item-container">
    <div class="col-sm-12" style="font-family: 'Roboto',sans-serif;text-align:left !important">
        HxIe-Processed by validated program no. 96/AGT/2019 | SAP Business One 10.0
    </div>
    <table>
        <tr style="font-family: 'Roboto',sans-serif;">
            <td>
                <p class="col-4 highlight-p text-start">
                    <span class="highlight">Created By:</span> {{ $warehouseCode }}
                </p>
            </td>
            <td>
                <p class="col-4 highlight-p text-center">
                    <span class="highlight">N/C Nº.:</span>{{ $order->credit_no }}
                </p>
            </td>
            <td>
                <p class="col-4 highlight-p text-center">
                    <span class="highlight">Reference No.</span>ALBINO
                </p>
            </td>
            <td>
    ...
    <div style="margin-top: 3px;font-family: 'Roboto',sans-serif;" class="customer-name">
    ...
    <div style="margin-top: 3px; border: solid 1px #000; border-bottom: none; padding-top: 5px;">
        <table class="invoice-summary">
            <tr style="font-family: 'Roboto',sans-serif;">
                <td><span class="highlight">N/C Nº.</span>{{ $order->credit_no }}</td>
                ...
                {{-- <td><span class="highlight">Tipo:</span> {{ $invoice->sales_type }}</td> --}}
                <td><span class="highlight">Ref:</span> {{ $warehouseCode }}</td>
            </tr>
        </table>
    </div>
                ...
                @foreach($items as $key => $item)
                    ...
                    @if(!empty($item->batches))
                        @foreach ($item->batches as $batch)
                            <tr style="padding: 1px !important;font-family: 'Roboto',sans-serif;">
                                ...
                                <td colspan="2" style="text-align: left; padding: 2px !important;">
                                    <span><strong>Data de Validade </strong>
                                        <span style="margin-left: 20px;">
                                            {{ \Carbon\Carbon::parse($batch['expiry_date'])->gte(\Carbon\Carbon::today()) ? \Carbon\Carbon::parse($batch['expiry_date'])->format('d-m-Y') : 'NA' }}
                                        </span>
                                    </span>
                                </td>
                            </tr>
 ...
 <div class="item-container">
    ...
    <div style="margin-top: 1px; border-top: solid 1px #000; padding-top: 1px;">
        ...
        <table style="width: auto; text-align: left;">
            <tr style="font-family: 'Roboto', sans-serif;">
                <td style="text-align: left;"><span class="highlight">Motivo:</span> {{ $order->motivo }}</td>
            </tr>
        </table>

    </div>

    <div style="margin-top: 1px; border-top: solid 1px #000; padding-top: 1px;font-family: 'Roboto', sans-serif;">
    ...
    <div class="declaration" style="font-family: 'Roboto', sans-serif;">
        <!--<p style="text-decoration: underline"><strong>Declaração:</strong></p>-->
        <div><span style="text-decoration: underline ; font-size:bold; text-indent: 10px; margin-right:10px;"> Declaração:</span><span style="font-size:14px; text-indent: 10px;">Os bens/serviços foram disponibilizados ao comprador na data de emissã da fatura</span> </div>

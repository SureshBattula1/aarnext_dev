...
<body>
                ...
                <tr>
                    ...
                    <th width="10%" style="text-align: center; vertical-align: top;">
                        <div class="invoice-title">
                            <span class="title-text">FACTURA</span>
                        </div>
                    </th>
                </tr>
            </table>
   ...
   <div class="footer item-container">
    <div class="col-sm-12 text-align:left">
        <span>{{ $invoice->hash_key }}</span> - Processado por programa validado n.º 96/AGT/2019 | SAP Business One 10.0
    </div>
    <table>
        <tr>
            <td>
            ...
            <td>
                <p class="col-4 highlight-p text-center">
                    <span class="highlight">Factura Nº. :</span> {{ $invoice->invoice_no }}
                </p>
            </td>
            <td>
    ...
    <div style="margin-top: 3px;" class="customer-name">
        <span><strong>Customer Name:</strong></span> {{ $invoice->customer_name }}
    </div>

    <div style="margin-top: 3px; border: solid 1px #000; border-bottom: none; padding-top: 5px;">
        <table class="invoice-summary">
            <tr>
                <td><span class="highlight">Factura Nº:</span>{{ $invoice->invoice_no }}</td>
                <td><span class="highlight">Data:</span>{{ \Carbon\Carbon::parse($invoice->order_date)->format('d-m-Y') }}</td>
                <td><span class="highlight">Data de Vencimento:</span>{{ \Carbon\Carbon::parse($invoice->due_date)->format('d-m-Y') }}</td>
                <td ><span class="highlight">Tipo:</span>
                    @php
                        $salesTypeMap = [
                            'cash' => 'VD',
                            'credit' => 'VC',
                    ...
                    @endphp
                    {{ $salesTypeMap[$invoice->sales_type] ?? $invoice->sales_type }}
                </td>
                <td><span class="highlight">Ref:</span> {{ $invoice->memo }}</td>
            </tr>
        </table>
    </div>

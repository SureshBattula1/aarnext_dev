...
@section('content')
    <div class="content-wrapper">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title">Muti. Category</h4>
                <div class="row">
    ...
    <script>
        $(document).ready(function() {
            var BranchListTable = $('#branch_table').DataTable({
                ...
                "ordering": false,
                "ajax": {
                    "url": public_path + '/sap-multi-category-customers-json',
                    "type": "GET",
                    "data": function(d) {
                        return $.extend({}, d, {
                ...
                "columns": [{
                    ...
                    {
                        "data": "distinct_slp_count",
                        "name": "distinct_slp_count",
                        "defaultContent": '-'
                    },
                    {
                        "data": "cntct_prsn",

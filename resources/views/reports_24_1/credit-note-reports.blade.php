...
<div class="content-wrapper">
    <div class="card">
        <div class="card-body">
            <h5 class="card-title">Credit Note Reports</h5>
            <div class="row">
...
<script>
    $(document).ready(function() {
        var itemsTable = $('#items_table').DataTable({
            ...
            "serverSide": true,
            "ajax": {
                "url": "{{ url('credit-note-reports-json') }}",
                "type": "GET",
                "data": function(d) {
                    console.log(d); // log the parameters being sent
            ...
            "columns": [
                { "data": 'id', "title": "ID" },
                { "data": 'sales_invoice_no', "title": "sales_invoice_no" },
                { "data": 'customer_id', "title": "Customer Id" },
                { "data": 'card_name', "title": "card_name" },
                { "data": 'order_date', "title": "Order Date" },
                { "data": 'credit_no', "title": "Credit No" },
    ...
    window.location.href = "{{ url('export-credit-note-report') }}?start_date=" + startDate + "&end_date=" + endDate + "&search_user="  + searchItems + "&sub_grp_search=" + subGrpSearch + "&status_search=" + statusSearch + "&page_length=" + pageLength;
});

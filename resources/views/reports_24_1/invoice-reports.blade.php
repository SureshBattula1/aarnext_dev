...
<script>
    ...
    $('#exportExcel').on('click', function() {
        ...
        window.location.href = "{{ url('export-invoice-report') }}?sales_type=" + salesType + "&start_date=" + startDate + "&end_date=" + endDate + "&search_user="  + searchItems + "&sub_grp_search=" + subGrpSearch + "&status_search=" + statusSearch + "&page_length=" + pageLength;
    });
</script>  
@endpush
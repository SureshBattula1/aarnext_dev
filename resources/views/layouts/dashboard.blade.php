  ...
  <ul class="nav">
    ...
    <li class="nav-item">
      ...
      <div class="collapse" id="ui-basic">
        <ul class="nav flex-column sub-menu">
          <li class="nav-item">
            <a class="nav-link" href="./pages/ui-features/accordions.html">
              Accordions
            </a>
          </li>
          <li class="nav-item">
          ...
          <li class="nav-item">
            <a class="nav-link" href="./pages/ui-features/badges.html">
              Badges
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="./pages/ui-features/breadcrumbs.html">
              Breadcrumbs
            </a>
          </li>
          <li class="nav-item">
          ...
          <li class="nav-item">
            <a class="nav-link" href="./pages/ui-features/modals.html">
              Modals
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="./pages/ui-features/progress.html">
              Progress bar
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="./pages/ui-features/pagination.html">
              Pagination
            </a>
          </li>
          <li class="nav-item">
          ...
          <li class="nav-item">
            <a class="nav-link" href="./pages/ui-features/tooltips.html">
              Tooltips
            </a>
          </li>
        </ul>
    ...
    <li class="nav-item">
      ...
      <div class="collapse" id="ui-advanced">
        <ul class="nav flex-column sub-menu">
          <li class="nav-item">
            <a class="nav-link" href="./pages/ui-features/dragula.html">
              Dragula
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="./pages/ui-features/clipboard.html">
              Clipboard
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="./pages/ui-features/context-menu.html">
              Context menu
            </a>
          </li>
          <li class="nav-item">
          ...
          <li class="nav-item">
            <a class="nav-link" href="./pages/ui-features/carousel.html">
              Carousel
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="./pages/ui-features/colcade.html">
              Colcade
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="./pages/ui-features/loaders.html">
              Loaders
            </a>
          </li>
        </ul>
    ...
    <li class="nav-item">
      ...
      <div class="collapse" id="form-elements">
        <ul class="nav flex-column sub-menu">
          ...
          <li class="nav-item">
            <a class="nav-link" href="./pages/forms/advanced_elements.html">
              Advanced Elements
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="./pages/forms/validation.html">
              Validation
            </a>
          </li>
          <li class="nav-item">
    ...
    <li class="nav-item">
      ...
      <div class="collapse" id="charts">
        <ul class="nav flex-column sub-menu">
          ...
          <li class="nav-item">
            <a class="nav-link" href="./pages/charts/google-charts.html">
              Google charts
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="./pages/charts/sparkline.html">
              Sparkline js
            </a>
          </li>
          <li class="nav-item">
          ...
          <li class="nav-item">
            <a class="nav-link" href="./pages/charts/justGage.html">
              JustGage
            </a>
          </li>
        </ul>
    ...
    <li class="nav-item">
      ...
      <div class="collapse" id="tables">
        <ul class="nav flex-column sub-menu">
          ...
          <li class="nav-item">
            <a class="nav-link" href="./pages/tables/data-table.html">
              Data table
            </a>
          </li>
          <li class="nav-item">
          ...
          <li class="nav-item">
            <a class="nav-link" href="./pages/tables/sortable-table.html">
              Sortable table
            </a>
          </li>
        </ul>
    ...
    <li class="nav-item">
      ...
      <div class="collapse" id="icons">
        <ul class="nav flex-column sub-menu">
          <li class="nav-item">
            <a class="nav-link" href="./pages/icons/flag-icons.html">
              Flag icons
            </a>
          </li>
          <li class="nav-item">
          ...
          <li class="nav-item">
            <a class="nav-link" href="./pages/icons/simple-line-icon.html">
              Simple line icons
            </a>
          </li>
          <li class="nav-item">
    ...
    <li class="nav-item">
      ...
      <div class="collapse" id="maps">
        <ul class="nav flex-column sub-menu">
          ...
          <li class="nav-item">
            <a class="nav-link" href="./pages/maps/vector-map.html">
              Vector Map
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="./pages/maps/google-maps.html">
              Google Map
            </a>
          </li>
        </ul>
    ...
    <li class="nav-item">
      ...
      <div class="collapse" id="general-pages">
        <ul class="nav flex-column sub-menu">
          ...
          <li class="nav-item">
            <a class="nav-link" href="./pages/samples/portfolio.html">
              Portfolio
            </a>
          </li>
        </ul>
    ...
    <li class="nav-item">
      <a
        class="nav-link"
        href="https://demo.bootstrapdash.com/justdo/docs/documentation.html">
            ...
            <div class="col-md-12 grid-margin">
              <div class="row">
                <div class="col-12 col-xl-5 mb-4 mb-xl-0">
                  ...
                  <h4 class="fw-normal mb-0">JustDo Dashboard,</h4>
                </div>
                    ...
                    <table class="table table-striped table-borderless">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td class="fw-bold">$362</td>
                          <td>21 Sep 2018</td>
                          <td class="fw-medium text-success">Completed</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                          ...
                          <td class="fw-bold">$551</td>
                          <td>28 Sep 2018</td>
                          <td class="fw-medium text-warning">Pending</td>
                        </tr>
                        <tr>
                          <td>Pay Per Click Advertising</td>
                          <td class="fw-bold">$523</td>
                          <td>30 Jun 2018</td>
                          <td class="fw-medium text-warning">Pending</td>
                        </tr>
                        <tr>
                          <td>E-Mail Marketing</td>
                          <td class="fw-bold">$781</td>
                          <td>01 Nov 2018</td>
                          <td class="fw-medium text-danger">Cancelled</td>
                        </tr>
                        <tr>
                          <td>Referral Marketing</td>
                          <td class="fw-bold">$283</td>
                          <td>20 Mar 2018</td>
                          <td class="fw-medium text-warning">Pending</td>
                        </tr>
                        <tr>
                          <td>Social media marketing</td>
                          <td class="fw-bold">$897</td>
                          <td>26 Oct 2018</td>
                          <td class="fw-medium text-success">Completed</td>
                        </tr>
                      </tbody>
                    ...
                    <table class="table table-borderless">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td><p class="mb-0"><span class="fw-bold me-2">65</span>(2.15%)</p></td>
                          <td class="text-muted">65</td>
                        </tr>
                        <tr>
                          <td class="text-muted ps-0">Ohio</td>
                          <td><p class="mb-0"><span class="fw-bold me-2">54</span>(3.25%)</p></td>
                          <td class="text-muted">51</td>
                        </tr>
                        <tr>
                          <td class="text-muted ps-0">Nevada</td>
                          <td><p class="mb-0"><span class="fw-bold me-2">22</span>(2.22%)</p></td>
                          <td class="text-muted">32</td>
                        </tr>
                        <tr>
                          <td class="text-muted ps-0">North Carolina</td>
                          <td><p class="mb-0"><span class="fw-bold me-2">46</span>(3.27%)</p></td>
                          <td class="text-muted">15</td>
                        </tr>
                        <tr>
                          <td class="text-muted ps-0">Montana</td>
                          <td><p class="mb-0"><span class="fw-bold me-2">17</span>(1.25%)</p></td>
                          <td class="text-muted">25</td>
                        </tr>
                        <tr>
                          <td class="text-muted ps-0">Nevada</td>
                          <td><p class="mb-0"><span class="fw-bold me-2">52</span>(3.11%)</p></td>
                          <td class="text-muted">71</td>
                        </tr>
                        <tr>
                          <td class="text-muted ps-0 pb-0">Louisiana</td>
                          <td class="pb-0"><p class="mb-0"><span class="fw-bold me-2">25</span>(1.32%)</p></td>

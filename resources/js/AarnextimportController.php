...
public function warehouseBatchExec2()
{
    ...
    public function SapInvoicePostByWeb($id)
    {
        ...
        try {
            ...
            echo $url = $this->url."Sales_Transactions/CreateInvoiceWithBatch.xsjs?&DBName=" . $this->sapDatabase;
    ...
    public function SapInvoicePostByCron()
    {
        ...
        try {
            ...
            $data = $this->prepareSapJson($invoice, $invoiceItems);
            $sapJson = $data['json'];
            $uniqueNumber = $data['unique'];
            ...
            try {
                $orderPayments = DB::table('order_payments')
                  ...
                  //  $dueDate = date('Ymd');
                    ...
                    ->where('id' , $orderPayments->user_id)
                    ->first();
    
                    if($checkRole->role != 1){
                        $accDetails = $checkRole;
                    } else {
